...
> 来源：移植自 Anthropic `anthropics/skills/skills/skill-creator/references/schemas.md`，字段名与本地 skill-creator 的 `run_eval.py` / `run_loop.py` / `aggregate_benchmark.py` 对齐。客户端无关（claude/opencode/codex/deepseek 通用）。
